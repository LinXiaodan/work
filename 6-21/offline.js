Geetest.define("Offline", ["Data", "Slide"], function(a, b) {
    ...
    c.ajax = function(c, d, e) {
        var f = a.t("x_pos", e.id);
        return c >= f - 3 && c <= f + 3 ? {
            success: !0,
            message: "success",
            validate: b.ra(c, e.config.challenge) + "_" + b.ra(a.t("rand0", e.id), e.config.challenge) + "_" + b.ra(a.t("rand1", e.id), e.config.challenge),
