...
!function(a, b) {
        ...
        , function(a) {
            ...
            f.serial([function(a) {
                ...
                if (z.loaded_theme[c.config.theme])
                    c.config.mobile && !z.mobileSkins[c.config.theme] ? k.u(c.config.theme + "Loaded", function() {
                        Q.G("loaded", !0, c.id),
                        k.v("loaded", c.id)
                    }) : (Q.G("loaded", !0, c.id),
                    k.v("loaded", c.id));
                ...
                c.config.mobile) {
                    ...
                    F(c, c.config.theme + "/skin." + c.config.theme_version + ".js", function(a) {
                        ...
                        void k.v("error", c.id)) : (z.mobileSkins[c.config.theme] = window.GeeTestSkins[c.config.theme],
                        k.y(c.config.theme + "Loaded"),
                        Q.G("loaded", !0, c.id),
                        void k.v("loaded", c.id))
                    })
                } else
    ...
    S.P = function(a, b) {
        ...
        c.config.mobile ? c.dom.className = "gt_mobile_holder " + c.config.product : c.dom.className = "gt_holder " + c.config.product + " gt_" + c.config.product,
    ...
    S.V = function(a) {
        ...
        c.target = "_blank") : (S._(c, "no_logo"),
        S._(c, "gt_no_logo")),
        a.config.clean && (S._(b(".gt_widget"), "clean"),
        S._(b(".gt_widget"), "gt_clean"));
    ...
    aa.b = [],
    aa.t = function(a, b) {
        for (var c, d = 0, e = aa.b.length; d < e; d++)
            if (c = aa.b[d],
            c.dom == a && c.event == b)
                return c;
        return c = {
    ...
    ,
    aa.e = function(a, b, c) {
        for (var d, e = aa.evts[b], f = aa.t(a, b), g = 0, h = e.length; g < h; g++)
            f.handlerList.length && (d = f.ia,
    ...
    ba.ia = function(a, b) {
        ...
        if (a || "error" === b.message)
            ...
            }, 1e3)) : "forbidden" == b.message ? (oa.Z("forbidden", c),
            pa.Z("forbidden", c),
            k.v("forbidden", c.id),
            setTimeout(function() {
                Q.G("status", "auto", c.id),
                c.refresh()
            }, 4e3)) : "abuse" == b.message && (oa.Z("abuse", c),
            pa.Z("fail", c),
            k.v("abuse", c.id),
            setTimeout(function() {
                Q.G("status", "auto", c.id),
    ...
    ia.c = function(a) {
        ...
        var c = a.$;
        aa.e(c(".gt_mask"), "click", function() {
            ia.Y(a)
        }),
        aa.e(c(".gt_popup_cross"), "click", function() {
            ia.Y(a)
        })
    }
    ,
    ...
    c.prototype.bindOn = function(a) {
        return Q.t("loaded", this.id) ? ia.ta.call(this, a) : k.u("loaded", function() {
            ia.ta.call(this, a)
        }, this.id),
        this
    }
      ...
      , ka = function(a) {
        ...
        if ("ready" === b || "success" === b || "auto" === b) {
            ...
            G(a.config.apiserver + "refresh.php?" + m({
                ...
                void k.v("error", a.id)) : void la(c, a)
            }, a)
        }
    }
      , la = function(a, b) {
    ...
    var ma = function(a) {
        if (a.config.mobile) {
            ...
            aa.e(a.$(".gt_refresh_button"), "click", ja(a));
        Q.G("autoRefresh", setTimeout(function() {
            a.refresh()
        }, 54e4), a.id),
        k.B("success", function() {
    ...
    ra.onError = function(a) {
        ...
        a || (b.config.mobile ? k.v("SvgError", b.id) : (Q.G("status", "error", b.id),
        pa.Z("error", b),
        oa.Z("error", b, !1)),
        clearTimeout(Q.t("autoRefresh", b.id)))
    }
